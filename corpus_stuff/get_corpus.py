...
def append_corpora_text(text_data):
    ...
    """
    if text_data:
        with open("/storage/ice-shared/vip-vyf/embeddings_team/corpora/extended_corpora_final.txt", "a", encoding="utf-8") as txt_file, open("extended_corpora_final.bin", "ab") as bin_file:
